...
> 🤖 **Увага:** Цей проєкт повністю написаний штучним інтелектом, включаючи код, документацію та README.
...
- 🌍 **Багатомовність:** ручний вибір мови між українською, російською, англійською та японською мовою (Інші мови буде додано, якщо принаймні хтось оцінить сучасні можливості ШІ)
- 📝 **Генерація субтитрів:** автоматичне створення .SRT файлів з таймкодами
- 🖱️ **Drag & Drop:** зручне завантаження файлів перетягуванням
- 📱 **Адаптивний дизайн:** працює на комп'ютерах, планшетах та смартфонах
...
### Приклади відео з субтитрами
У папці `examples/` знаходяться відеофайли з автоматично згенерованими субтитрами:
- `example3_with_subs.mp4` - Приклад російської мови
